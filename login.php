...
<div class="login-card">
    ...
    <form method="POST" <?= $lockout_remaining > 0 ? 'onsubmit="return false;"' : '' ?>>
        ...
        <div class="form-floating">
            <input type="text" class="form-control" id="username" name="username" placeholder="Username" required autocomplete="username" <?= $lockout_remaining > 0 ? 'disabled' : '' ?>>
            <label for="username"><i class="fas fa-user me-2"></i>Username</label>
        </div>
        <div class="form-floating">
            <input type="password" class="form-control" id="password" name="password" placeholder="Password" required autocomplete="current-password" <?= $lockout_remaining > 0 ? 'disabled' : '' ?>>
