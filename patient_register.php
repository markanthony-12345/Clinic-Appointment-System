...
function validateContact($contact) {
    ...
    if (strlen($digits) !== 11) {
        return "Contact number must be exactly 11 digits (e.g., 9123456789).";
    }
    return true;
}
                    ...
                    <form method="POST" id="registerForm">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" name="contact_number" class="form-control" required pattern="[0-9]{11}" title="Exactly 11 digits (e.g., 9123456789)" placeholder="9123456789">
                            </div>
