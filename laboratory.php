...
=======
        ...
        <div class="card">
            ...
            <table class="table">
                <thead>
                    <tr><th>ID</th><th>Patient</th><th>Test</th><th>Status</th><th>Result</th><th>Date</th><th>Actions</th></tr>
                </thead>
                <tbody>
                    <?php foreach ($labRecords as $row): ?>
                    <tr>
...
>>>>>>> 7cce955bf02c10342e377f3e5b762fcb42e371c8
...
function editLab(id) { window.location.href = `edit_lab.php?id=${id}`; }
function deleteLab(id) {
    if (confirm('Delete this record?')) window.location.href = `delete_lab.php?id=${id}`;
}
</script>
</body>
</html>