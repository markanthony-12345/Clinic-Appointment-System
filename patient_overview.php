                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                ...
                                <?php
                                // Payment clearance: show check only if there are charges AND balance <= 0
                                // If no charges, show "No Charges" without check
                                if ($total == 0): ?>
                                    <span class="badge bg-secondary">No Charges</span>
                                <?php elseif ($balance <= 0): ?>
                            ...
                            <div class="mt-3">
                                <?php
                                // Payment is cleared if no charges OR balance <= 0
